...
function HomePage({ 
  ...
  setSheet,
  fishingReadiness = 86,
  readinessLevel = { level: 'excellent', label: 'EXCELLENT', color: 'text-green-600' }
}) {
  return (
    <>
      {/* ACTIVE TRIP CARD */}
      ...
      <div className="relative mt-3 rounded-3xl overflow-hidden shadow-xl">
        ...
        <div className="relative p-6 backdrop-blur-sm bg-white/5">
          ...
          <div className="flex items-center gap-1 mt-2">
            ...
            <span className={`font-semibold text-sm ml-2 tracking-wide ${readinessLevel.color}`}>
          ...
          <div className="mt-5 flex items-center justify-between bg-white/10 rounded-2xl px-4 py-3">
            ...
            <button
              ...
              disabled={!!activeTrip}
              className="flex items-center gap-1 bg-white text-blue-900 font-semibold text-sm px-4 py-2 rounded-full shadow-md active:scale-95 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 -mx-1 px-1">
          {community.length > 0 ? (
            ...
            <div className="w-full text-center py-8 text-slate-400">
              <p>Belum ada aktivitas komunitas</p>
            </div>
          )}
        </div>
      </div>
